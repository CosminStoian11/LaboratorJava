...
-the customer must have an name, email address and the address

-the address filed must contain the street, postal code, city, country and the delivery instructions

-the address and also the customer can be updated
...
#### 4.The customer can update the address

-the customer can update the address that was provided to the application
...
#### For Minimum Viable Product: 1,4,6,7,8 business requirements
